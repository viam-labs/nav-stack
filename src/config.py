...
class LidarConfig:
    ...
    # viam-shared-memory-test double-buffer layout. When set, the scan path
    # tries shm before ``get_point_cloud``. Needs a writer (native lidar or
    # ``viam-labs:nav-stack:shm-pointcloud``).
    ...
    def from_dict(cls, d: Mapping) -> "LidarConfig":
        ...
        region = int(d.get("shm_region_size", d.get("shm_region_size_bytes", 2 * 1024 * 1024)))
