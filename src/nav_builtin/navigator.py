    ...
    def __init__(
        ...
        *,
        ...
        self._kwargs = dict(
            ...
            spin_radius_m=spin_radius_m,
            nose_offset_m=nose_offset_m,
            wheel_half_track_m=wheel_half_track_m,
            ...
            local_costmap_rate_hz=local_costmap_rate_hz,
            ...
            local_planner_max_vel_x_mps=local_planner_max_vel_x_mps,
            ...
            recovery_wait_duration_s=recovery_wait_duration_s,
            ...
            max_linear_decel_mps2=max_linear_decel_mps2,
