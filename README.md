...
| `localize_spin_recovery` | Nav (`builtin`) | Optional rotate-in-place when lost (default **`false`** — a 360° lidar already has the view). Prefer the still + bad-fit full-map watchdog below. |
